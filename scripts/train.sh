...
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.launch --nproc_per_node=4 main.py --arch UNet --dataset hanco --epochs 500 --data-dir /media/NAS/DATASET/HanCo/preprocessed_50k --batch-size 256 --sampling-steps 100 --save-every 50 \
