...
# Default datasets if not speified
DEFAULT_DATASETS=("train_train,train_val")
...
# Set to true to skip sampling and only calculate FID scores
only_FID=true
...
for model_dir in "${!models[@]}"; do
    ...
    python fid.py --dirs "${model_dir}" --datasets "${DATASETS[@]}"
done
